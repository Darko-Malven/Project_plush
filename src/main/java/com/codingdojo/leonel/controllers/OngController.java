...
import com.codingdojo.leonel.models.Category;
...
public class OngController {
	...
	public String index(@ModelAttribute ("newOng") Organization ong,Model model) {
		model.addAttribute("category", Category.Categories);
